...
| --- | --- | --- | --- | --- | --- | 
| FANoS | ![arXiv'26](https://img.shields.io/badge/arXiv'26-d9534f) | FANoS: Friction-Adaptive Nos´e–Hoover Symplectic Momentum for Stiff Objectives | [Link](https://arxiv.org/pdf/2601.00889) | Accelerating Convergence Rate | Momentum Damping Mechanism | 
| NOVAK | ![arXiv'26](https://img.shields.io/badge/arXiv'26-d9534f) | NOVAK: Unified adaptive optimizer for deep neural networks | [Link](https://arxiv.org/abs/2601.07876) | Hybrid Methods | Gradient Smoothing Hybrid | 
| HomeAdam | ![arXiv'26](https://img.shields.io/badge/arXiv'26-d9534f) | HomeAdam: Adam and AdamW Algorithms Sometimes Go Home to Obtain Better Provable Generalization | [Link](https://arxiv.org/abs/2603.02649) | Adaptive Step-Size Control | Second-order moment adaptation | 
| FlashOptim | ![arXiv'26](https://img.shields.io/badge/arXiv'26-d9534f) | FlashOptim: Optimizers for Memory-Efficient Training | [Link](https://arxiv.org/abs/2602.23349) | Memory-Efficient Optimization | Low-Memory Optimizer Design |
...
| AutoSGD | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | AutoSGD: Automatic Learning Rate Selection for Stochastic Gradient Descent | [Link](https://arxiv.org/abs/2505.21651) | Learning Rate Scheduling | Scheduler-Free Adaptation | 
...
| AdaGC | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | AdaGC: Improving Training Stability for Large Language Model Pretraining | [Link](https://arxiv.org/abs/2502.11034) | Gradient Normalization & Clipping； Robust Optimization | Noise-Robust Normalization； Dynamic Gradient Clipping； Noise-Robust Gradients | 
| AdamS | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | AdamS: Momentum Itself Can Be A Normalizer for LLM Pretraining and Post-training | [Link](https://arxiv.org/abs/2505.16363) | Adaptive Learning Rate Methods | Stateless Adaptation |
| SCSAdamW | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Beyond First-Order: Training LLMs with Stochastic Conjugate Subgradients and AdamW | [Link](https://arxiv.org/abs/2507.01241) | Loss Landscape Optimization | Momentum Landscape Adaptation |
| adaNPAG | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Boosting Accelerated Proximal Gradient Method with Adaptive Sampling for Stochastic Composite Optimization * | [Link](https://arxiv.org/abs/2507.18277) | Momentum-Enhanced SGD | Accelerated Momentum |
...
| SoftSignSGD | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | SoftSignSGD(S3): An Enhanced Optimizer for Practical DNN Training and Loss Spikes Minimization Beyond Adam | [Link](https://arxiv.org/abs/2507.06464) | Adaptive Learning Rate Methods | Hybrid Adaptive Strategy | 
...
| Adadiag | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Improving Adaptive Moment Optimization viaPreconditioner Diagonalization | [Link](https://arxiv.org/abs/2502.07488) | Hybrid Methods | Projection Gradient Hybrid |
...
| GCSAM | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | GCSAM: Gradient Centralized Sharpness Aware Minimization | [Link](https://arxiv.org/abs/2501.11584) | Gradient Normalization & Clipping | Mean-Removal Normalization | 
| AsyncSAM | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | ASYNCHRONOUS SHARPNESS-AWARE MINIMIZATION FOR FAST AND ACCURATE DEEP LEARNING | [Link](https://arxiv.org/abs/2503.11147) | Loss Landscape Optimization | Sharpness-Aware Minimization (SAM) | 
| LightSAM | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | LightSAM: Parameter-Agnostic Sharpness-Aware Minimization | [Link](https://arxiv.org/abs/2505.24399) | Loss Landscape Optimization | Sharpness-Aware Minimization (SAM) | 
| ADAGB2 | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Fast Stochastic Second-Order Adagrad for Nonconvex Bound-Constrained Optimization | [Link](https://arxiv.org/abs/2505.06374) | Hybrid Methods | Projection Gradient Hybrid | 
| Splus | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | A Stable Whitening Optimizer for Efficient Neural Network Training | [Link](https://arxiv.org/abs/2506.07254) | Preconditioned Gradient Methods | Two Metrics' Preconditioner | 
| ASGO | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | ASGO: Adaptive Structured Gradient Optimization | [Link](https://arxiv.org/abs/2503.20762) | Preconditioned Gradient Methods | Single Metric's Preconditioner | 
| AdaMuon | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | ADAMUON: ADAPTIVE MUON OPTIMIZER | [Link](https://arxiv.org/abs/2507.11005) | Adaptive Learning Rate Methods | Hybrid Adaptive Strategy | 
| Accelerated GRAAL | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | NESTEROV FINDS GRAAL: OPTIMAL AND ADAPTIVE GRADIENT METHOD FOR CONVEX OPTIMIZATION | [Link](https://arxiv.org/abs/2507.09823) | Hybrid Methods | Multi-Objective Hybrid | 
| eagle | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | EAGLE: EARLY APPROXIMATED-GRADIENT-BASED LEARNING RATE ESTIMATOR | [Link](https://arxiv.org/abs/2502.01036) | Adaptive Learning Rate Methods | Momentum-based Adaptive | 
...
| VRAdam | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | A Physics-Inspired Optimizer: Velocity Regularized Adam | [Link](https://arxiv.org/abs/2505.13196) | Momentum-Enhanced SGD | Momentum Damping Mechanism | 
| AlphaGrad | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | AlphaGrad: Non-Linear Gradient Normalization Optimizer | [Link](https://arxiv.org/abs/2504.16020) | Adaptive Learning Rate Methods； Low-Memory Optimizer Design； Stateless Optimization Methods | Stateless Adaptation； Structural Redesign； Parameter Characteristic-Driven Updates | 
| EXADAM | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | EXADAM: THE POWER OF ADAPTIVE CROSS-MOMENTS | [Link](https://arxiv.org/abs/2412.20302) | Adaptive Learning Rate Methods | Hybrid Adaptive Strategy |
| HGM | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Hindsight-Guided Momentum (HGM) Optimizer: An Approach to Adaptive Learning Rates | [Link](https://arxiv.org/abs/2506.22479) | Learning Rate Scheduling | Gradient Angle Scheduling | 
| CAdam | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | CAdam: Confidence-Based Optimization for Online Learning | [Link](https://arxiv.org/abs/2411.19647) | Hybrid Methods | Multi-Objective Hybrid | 
| DEO | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Dimer-Enhanced Optimization: A First-Order Approach to Escaping Saddle Points in Neural Network Training | [Link](https://arxiv.org/abs/2507.19968) | Loss Landscape Optimization | Curvature-Guided Landscape Exploration |
| LyAm | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | LyAm: Robust Non-Convex Optimization for Stable Learning in Noisy Environments | [Link](https://arxiv.org/abs/2507.11262) | Learning Rate Scheduling | Stability-Aware Adaptive Scheduling |
| ZetA | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | ZETA: A HYBRID OPTIMIZER COMBINING RIEMANN ZETA SCALING WITH ADAM FOR ROBUST DEEP LEARNING | [Link](https://arxiv.org/abs/2508.02719) | Hybrid Methods | Multi-Objective Hybrid | 
...
| SKA-SGD | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | STREAMING KRYLOV-ACCELERATED STOCHASTIC GRADIENT DESCENT | [Link](https://arxiv.org/abs/2505.07046) | Loss Landscape Optimization | Curvature-Guided Landscape Exploration | 
| SGDO | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Overshoot: Taking advantage of future gradients in momentum-based stochastic optimization | [Link](https://arxiv.org/abs/2501.09556) | Momentum-Enhanced SGD | Accelerated Momentum | 
| Adam-Power | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | GradPower: Powering Gradients for Faster Language Model Pre-Training | [Link](https://arxiv.org/abs/2505.24275) | Adaptive Learning Rate Methods | Second-Order Moment Adaptation | 
| Hessian-aware Scaling | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | First-ish Order Methods: Hessian-aware Scalings of Gradient Descent | [Link](https://arxiv.org/abs/2502.03701) | Preconditioned Gradient Methods | Single Metric's Preconditioner |
| NIRMAL | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | COMPARATIVE ANALYSIS OF NOVEL NIRMAL OPTIMIZER AGAINST ADAM AND SGD WITH MOMENTUM | [Link](https://arxiv.org/abs/2508.04293) | Hybrid Methods | Multi-Objective Hybrid |
...
| INNAprop | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | A SECOND-ORDER-LIKE OPTIMIZER WITH ADAPTIVE GRADIENT SCALING FOR DEEP LEARNING | [Link](https://arxiv.org/abs/2410.05871) | Adaptive Learning Rate Methods | Momentum-based Adaptive | 
...
| AdamNX | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | AdamNX: An Adam improvement algorithm based on a novel exponential decay mechanism for the second-order moment estimate | [Link](https://arxiv.org/abs/2511.13465) | Adaptive Learning Rate Methods | Second-Order Moment Adaptation | 
| ROOT | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | ROOT: Robust Orthogonalized Optimizer for Neural Network Training | [Link](https://arxiv.org/abs/2511.20626) | Adaptive Learning Rate Methods | Momentum-based Adaptive |
| AuON | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | AuON: A Linear-time Alternative to Orthogonal Momentum Updates | [Link](https://arxiv.org/abs/2509.24320) | Gradient Normalization & Clipping | Layer-Wise Gradient Normalization | 
| BADM | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | BADM: Batch ADMM for Deep Learning | [Link](https://arxiv.org/abs/2407.01640) | Hybrid Methods | Multi-Objective Hybrid |
| SGD-SaI | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | No More Adam: Learning Rate Scaling at Initialization is All You Need | [Link](https://arxiv.org/abs/2412.11768) | Learning Rate Scheduling； Stateless Optimization Methods | Initial Learning Rate Scaling； Parameter Characteristic-Driven Updates | 
...
| MSAM | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | Momentum-SAM: Sharpness Aware Minimization without Computational Overhead | [Link](https://arxiv.org/abs/2401.12033) | Loss Landscape Optimization | Momentum Landscape Adaptation | 
...
| Adam++ | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | Towards Simple and Provable Parameter-Free Adaptive Gradient Methods | [Link](https://arxiv.org/abs/2412.19444) | Learning Rate Scheduling | Scheduler-Free Adaptation |
...
| FAdam | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | FAdam: Adam is a natural gradient optimizer using diagonal empirical Fisher information | [Link](https://arxiv.org/abs/2405.12807) | Adaptive Learning Rate Methods； Hybrid Methods | Dynamic Epsilon Adjustment； Multi-Objective Hybrid | 
| CaAdam | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | CaAdam: Improving Adam optimizer using connection aware methods | [Link](https://arxiv.org/abs/2410.24216) | Adaptive Learning Rate Methods | Layer-Wise Adaptation | 
...
| Cautious Optimizers | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | Cautious Optimizers: Improving Training with One Line of Code | [Link](https://arxiv.org/abs/2411.16085) | Momentum-Enhanced SGD | Momentum-Gradient Alignment | 
| AGS-GD | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | Anisotropic Gaussian Smoothing for Gradient-based Optimization | [Link](https://arxiv.org/abs/2411.11747) | Hybrid Methods； Auto-Designed Optimizers | Gradient Smoothing Hybrid； Automated Discovery&Theoretical Derivation | 
...
| AdaLOMO | ![arXiv'23](https://img.shields.io/badge/arXiv'23-d9534f) | AdaLomo: Low-memory Optimization with Adaptive Learning Rate | [Link](https://arxiv.org/abs/2310.10195) | Adaptive Learning Rate Methods | Second-Order Moment Adaptation | 
...
| SGDF | ![arXiv'23](https://img.shields.io/badge/arXiv'23-d9534f) | Signal Processing Meets SGD: From Momentum to Filter | [Link](https://arxiv.org/abs/2311.02818) | Momentum-Enhanced SGD | Dynamic Momentum Weight | 
...
| DP-SGD | ![arXiv'22](https://img.shields.io/badge/arXiv'22-d9534f) | Normalized/Clipped SGD with Perturbation for Differentially Private Non-Convex Optimization | [Link](https://arxiv.org/abs/2206.13033) | Gradient Normalization & Clipping | Basic Fixed Gradient Clipping | 
...
| Amos | ![arXiv'22](https://img.shields.io/badge/arXiv'22-d9534f) | Amos: AN ADAM-STYLE OPTIMIZER WITH ADAPTIVE WEIGHT DECAY TOWARDS MODEL-ORIENTED SCALE | [Link](https://arxiv.org/abs/2210.11693) | Learning Rate Scheduling | Scheduler-Free Adaptation |
| AdamFamily | ![arXiv'22](https://img.shields.io/badge/arXiv'22-d9534f) | AdaFamily: A family of Adam-like adaptive gradient methods | [Link](https://arxiv.org/abs/2203.01603) | Adaptive Learning Rate Methods | Hybrid Adaptive Strategy | 
...
| AdaL | ![arXiv'21](https://img.shields.io/badge/arXiv'21-d9534f) | AdaL: Adaptive Gradient Transformation Contributes to Convergences and Generalizations | [Link](https://arxiv.org/abs/2107.01525) | Adaptive Learning Rate Methods | Hybrid Adaptive Strategy | 
| AngularGrad | ![arXiv'21](https://img.shields.io/badge/arXiv'21-d9534f) | AngularGrad: A New Optimization Technique for Angular Convergence of Neural Networks | [Link](https://arxiv.org/abs/2105.10190) | Momentum-Enhanced SGD | Momentum-Gradient Alignment | 
| AdamD | ![arXiv'21](https://img.shields.io/badge/arXiv'21-d9534f) | AdamD: Improved bias-correction in Adam | [Link](https://arxiv.org/abs/2110.10828) | Adaptive Learning Rate Methods | Bias Correction Rules Adaptaion | 
...
| AdaSGD | ![arXiv'20](https://img.shields.io/badge/arXiv'20-d9534f) | AdaSGD: Bridging the gap between SGD and Adam | [Link](https://arxiv.org/abs/2006.16541) | Adaptive Learning Rate Methods； Hybrid Methods | Hybrid Adaptive Strategy； SGD-Adam Hybrid | 
...
| ADAS | ![arXiv'20](https://img.shields.io/badge/arXiv'20-d9534f) | ADAS: ADAPTIVE SCHEDULING OF STOCHASTIC GRADIENTS | [Link](https://arxiv.org/abs/2006.06587) | Learning Rate Scheduling | Scheduler-Free Adaptation | 
...
| LaProp | ![arXiv'20](https://img.shields.io/badge/arXiv'20-d9534f) | LaProp: Separating Momentum and Adaptivity in Adam | [Link](https://arxiv.org/abs/2002.04839) | Adaptive Learning Rate Methods |  |
...
| Adam+ | ![arXiv'20](https://img.shields.io/badge/arXiv'20-d9534f) | Adam+: A Stochastic Method with Adaptive Variance Reduction | [Link](https://arxiv.org/abs/2011.11985) | Adaptive Learning Rate Methods | Momentum-based Adaptive | 
...
| EAdam | ![arXiv'20](https://img.shields.io/badge/arXiv'20-d9534f) | EAdam Optimizer: How ∈ Impact Adam | [Link](https://arxiv.org/abs/2011.02150) | Adaptive Learning Rate Methods | Dynamic Epsilon Adjustment |
...
| ADASS | ![arXiv'19](https://img.shields.io/badge/arXiv'19-d9534f) | ADASS: Adaptive Sample Selection for Training Acceleration | [Link](https://arxiv.org/abs/1906.04819) | Hybrid Methods | Gradient Filtering Hybrid | 
...
| NovoGrad | ![arXiv'19](https://img.shields.io/badge/arXiv'19-d9534f) | Stochastic Gradient Methods with Layer-wise Adaptive Moments for Training of Deep Networks | [Link](https://arxiv.org/abs/1905.11286) | Adaptive Learning Rate Methods | Layer-Wise Adaptation | 
...
| LARS | ![arXiv'17](https://img.shields.io/badge/arXiv'17-d9534f) | Large batch training of Convolutional Network | [Link](https://arxiv.org/abs/1708.03888) | Adaptive Learning Rate Methods | Layer-Wise Adaptation |
...
| Abbreviation | Venue & Year | Paper Title | Project | Sub-methods | Fine-grained Methods | 
| --- | --- | --- | --- | --- | --- | 
| RACS | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Towards Efficient Optimizer Design for LLM via Structured Fisher Approximation with a Low-Rank Extension | [Link](https://arxiv.org/abs/2502.07752) | Fisher Information Matrix Application | Diagonal Fisher Approximation | 
...
| OCAR | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Online Curvature-Aware Replay: Leveraging 2nd Order Information for Online Continual Learning | [Link](https://arxiv.org/abs/2502.01866) | Fisher Information Matrix Application | Diagonal Fisher Approximation | 
| Q-Newton | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Q-Newton: Hybrid Quantum-Classical Scheduling for Accelerating Neural Network Training with Newton’s Gradient Descent | [Link](https://arxiv.org/abs/2405.00252) | Hessian Approximation & Estimation | Block Hessian Approximation |
| MAC | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | MAC: AN EFFICIENT GRADIENT PRECONDITIONING USING MEAN ACTIVATION APPROXIMATED CURVATURE | [Link](https://arxiv.org/abs/2506.08464) | Fisher Information Matrix Application | Curvature-Aware Approximation | 
| S-BFGS | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | EFFICIENT STOCHASTIC BFGS METHODS INSPIRED BY BAYESIAN PRINCIPLES | [Link](https://arxiv.org/abs/2507.07729) | Quasi-Newton Methods | Stochastic BFGS | 
| CRNAS | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | Novel Optimization Techniques for Parameter Estimation | [Link](https://arxiv.org/abs/2407.04235) | Hessian Approximation & Estimation | Diagonal Hessian Approximation | 
...
| OptiQ | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | Second-Order Optimization via Quiescence | [Link](https://arxiv.org/abs/2410.08033) | Curvature-Guided Preconditioning | Hessian Diagonal Preconditioning | 
| SOAA | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | EFFICIENT SECOND-ORDER NEURAL NETWORK OPTIMIZATION VIA ADAPTIVE TRUST REGION METHODS | [Link](https://arxiv.org/abs/2410.02293) | Fisher Information Matrix Application | Diagonal Fisher Approximation | 
...
| Athena | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | Athena: Efficient Block-Wise Post-Training Quantization for Large Language Models Using Second-Order Matrix Derivative Information | [Link](https://arxiv.org/abs/2405.17470) | Hessian Approximation & Estimation | Block Hessian Approximation |
...
| SGN | ![arXiv'20](https://img.shields.io/badge/arXiv'20-d9534f) | On the Promise of the Stochastic Generalized Gauss-Newton Method for Training DNNs | [Link](https://arxiv.org/abs/2006.02409) | Hessian Approximation & Estimation | Stochastic Hessian Sampling | 
...
| LORENZA | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | LORENZA: Enhancing Generalization in Low-Rank Gradient LLM Training and Fine-Tuning via Efficient Zeroth-Order Adaptive SAM Optimization | [Link](https://arxiv.org/abs/2502.19571) | Adaptive Methods | Momentum-based Adaptive； Low-Rank Adaptive | 
...
| MaZO | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | MaZO: Masked Zeroth-Order Optimization for Multi-Task Fine-Tuning of Large Language Models | [Link](https://arxiv.org/abs/2502.11513) | Memory-efficient Methods | Sparse Parameter Zeroth-Order | 
| ZO2 | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | ZO2: Scalable Zeroth-Order Fine-Tuning for Extremely Large Language Models with Limited GPU Memory | [Link](https://arxiv.org/abs/2503.12668) | Memory-efficient Methods | Inference-Level Memory Zeroth-Order | 
| KerZOO | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | KerZOO: Kernel Function Informed Zeroth-Order Optimization for Accurate and Accelerated LLM Fine-Tuning | [Link](https://arxiv.org/abs/2505.18886) | Memory-efficient Methods | Inference-Level Memory Zeroth-Order | 
| QZO | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Fine-tuning Quantized Neural Networks with Zeroth-order Optimization | [Link](https://arxiv.org/abs/2505.13430) | Memory-efficient Methods | Quantized Zeroth-Order Finetuning | 
| FZOO | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | FZOO: Fast Zeroth-Order Optimizer for Fine-Tuning Large Language Models towards Adam-Scale Speed | [Link](https://arxiv.org/abs/2506.09034) | Variance Reduction | Structured Variance Control | 
| TeZO | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | TeZO: Empowering the Low-Rankness on the Temporal Dimension in the Zeroth-Order Optimization for Fine-tuning LLMs | [Link](https://arxiv.org/abs/2501.19057) | Memory-efficient Methods | Low-Rank Zeroth-Order Finetuning | 
| DiZO | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Harmony in Divergence: Towards Fast, Accurate, and Memory-efficient Zeroth-order LLM Fine-tuning | [Link](https://arxiv.org/abs/2502.03304) | Adaptive Methods | Projection-based Adaptive | 
...
| ELASTICZO | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | ELASTICZO: A MEMORY-EFFICIENT ON-DEVICE LEARNING WITH COMBINED ZEROTH- AND FIRST-ORDER OPTIMIZATION | [Link](https://arxiv.org/abs/2501.04287) | Zeroth-First Order Hybrid | Layer-Wise Hybrid | 
...
| VAMO | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | VAMO: Efficient Large-Scale Nonconvex Optimization via Adaptive Zeroth Order Variance Reduction | [Link](https://arxiv.org/abs/2505.13954) | Zeroth-First Order Hybrid； Variance Reduction | Variance Reduction Hybrid； Snapshot Variance Reduction |
| VR-SZD | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | A Structured Proximal Stochastic Variance Reduced Zeroth-order Algorithm | [Link](https://arxiv.org/abs/2506.23758) | Variance Reduction | Snapshot Variance Reduction | 
| ZO-SAH | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Subspace-based Approximate Hessian Method for Zeroth-Order Optimization | [Link](https://arxiv.org/abs/2507.06125) | Adaptive Methods | Projection-based Adaptive |
...
| Sparse MeZO | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | Sparse MeZO: Less Parameters for Better Performance in Zeroth-Order LLM Fine-Tuning | [Link](https://arxiv.org/abs/2402.15751) | Perturbation Optimization； Memory-efficient Methods； Memory-Efficient Fine-Tuning for Large Models | Sparse Perturbation； Sparse Parameter Zeroth-Order； Selective Parameter Fine-Tuning | 
| LeZO | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | SIMULTANEOUS COMPUTATION AND MEMORY EFFICIENT ZEROTH-ORDER OPTIMIZER FOR FINE-TUNING LARGE LANGUAGE MODELS | [Link](https://arxiv.org/abs/2410.09823) | Perturbation Optimization； Memory-efficient Methods； Memory-Efficient Fine-Tuning for Large Models | Sparse Perturbation； Sparse Parameter Zeroth-Order； Selective Parameter Fine-Tuning | 
| SuZero | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | Zeroth-Order Fine-Tuning of LLMs in Random Subspaces | [Link](https://arxiv.org/abs/2410.08989) | Memory-efficient Methods | Low-Rank Zeroth-Order Finetuning | 
...
| LT-ADMM | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Communication-Efficient Stochastic Distributed Learning | [Link](https://arxiv.org/abs/2501.13516) | Decentralized Communication | Distributed Consensus Optimization | 
| HybridSGD | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Communication-Efficient, 2D Parallel Stochastic Gradient Descent for Distributed-Memory Optimization | [Link](https://arxiv.org/abs/2501.07526) | Local Update Strategies | Local-Global Hybrid Updates | 
| ADEF | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Accelerated Distributed Optimization with Compression and Error Feedback | [Link](https://arxiv.org/abs/2503.08427) | Gradient Compression & Quantization | Compression Error Compensation | 
| TAH-QUANT | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | TAH-QUANT: Effective Activation Quantization in Pipeline Parallelism over Slow Network | [Link](https://arxiv.org/abs/2506.01352) | Gradient Compression & Quantization | Quantization Compression | 
| DEC-LOC | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | DES-LOC: Desynced Low Communication Adaptive Optimizers for Training Foundation Models | [Link](https://arxiv.org/abs/2505.22549) | Decentralized Communication | Distributed Consensus Optimization | 
| LQ-SGD | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Trustworthy Efficient Communication for Distributed Learning using LQ-SGD Algorithm | [Link](https://arxiv.org/abs/2506.17974) | Gradient Compression & Quantization； Low-Rank Methods | Quantization Compression； Low-Rank & Quantization | 
| Deco-SGD | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | DeCo-SGD: Joint Optimization of Delay Staleness and Gradient Compression Ratio for Distributed SGD | [Link](https://arxiv.org/abs/2507.17346) | Gradient Compression & Quantization； Local Update Strategies | Adaptive Compression Level； Local-Global Hybrid Updates | 
| DLAS-R-FTC | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Distributed Optimization and Learning for Automated Stepsize Selection with Finite Time Coordination | [Link](https://arxiv.org/abs/2508.05887) | Decentralized Communication | Distributed Consensus Optimization | 
| FedCET | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Communication Efficient Federated Learning with Linear Convergence on Heterogeneous Data | [Link](https://arxiv.org/abs/2503.15804) | Local Update Strategies | Adaptive Local Steps | 
| FAdamGC | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Gradient Correction in Federated Learning with Adaptive Optimization | [Link](https://arxiv.org/abs/2502.02727) | Federated Learning Optimization | Client Sampling Optimization | 
| FedCurv | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Blockchain-Enabled Privacy-Preserving Second-Order Federated Edge Learning in Personalized Healthcare | [Link](https://arxiv.org/abs/2506.00416) | Federated Learning Optimization | Federated Second-Order Optimization | 
| Kuramoto-FedAvg | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Kuramoto-FedAvg: Using Synchronization Dynamics to Improve Federated Learning Optimization under Statistical Heterogeneity | [Link](https://arxiv.org/abs/2505.19605) | Federated Learning Optimization | Federated Momentum Fusion | 
| pFedSOP | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | pFedSOP : Accelerating Training Of Personalized Federated Learning Using Second-Order Optimization | [Link](https://arxiv.org/abs/2506.07159) | Federated Learning Optimization | Federated Second-Order Optimization |
| FedOne | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | FedOne: Query-Efficient Federated Learning for Black-box Discrete Prompt Learning | [Link](https://arxiv.org/abs/2506.14929) | Federated Learning Optimization | Client Sampling Optimization | 
| AbsSADMM | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Stochastic ADMM with batch size adaptation for nonconvex nonsmooth optimization | [Link](https://arxiv.org/abs/2505.06921) | Local Update Strategies | Adaptive Local Steps |
| FedMuon | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | FedMuon: Accelerating Federated Learning with Matrix Orthogonalization | [Link](https://arxiv.org/abs/2510.27403) | Federated Learning Optimization | Federated Momentum Fusion | 
...
| FAGH | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | FAGH: Accelerating Federated Learning with Approximated Global Hessian | [Link](https://arxiv.org/abs/2403.11041) | Federated Learning Optimization | Federated Second-Order Optimization |
| FedIvon | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | Federated Learning with Uncertainty and Personalization via Efficient Second-order Optimization | [Link](https://arxiv.org/abs/2411.18385) | Federated Learning Optimization | Personalized Federated Optimization | 
| FedSTaS | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | FedSTaS: Client Stratification and Client Level Sampling for Efficient Federated Learning | [Link](https://arxiv.org/abs/2412.14226) | Federated Learning Optimization | Client Sampling Optimization | 
| Fed-Sophia | ![ICC'24](https://img.shields.io/badge/ICC'24-dfb317?labelColor=dfb317&color=dfb317&logoColor=1a202c) | Fed-Sophia: A Communication-Efficient Second-Order Federated Learning Algorithm | [Link](https://arxiv.org/abs/2406.06655) | Hessian Approximation & Estimation； Federated Learning Optimization | Diagonal Hessian Approximation； Federated Second-Order Optimization |
...
| FedLAP-DP | ![arXiv'23](https://img.shields.io/badge/arXiv'23-d9534f) | FedLAP-DP: Federated Learning by Sharing Differentially Private Loss Approximations | [Link](https://arxiv.org/abs/2302.01068) | Decentralized Communication | Privacy-Preserving Decentralization | 
...
| SQuARM-SGD | ![JSAIT'21](https://img.shields.io/badge/JSAIT'21-0275d8) | SQuARM-SGD: Communication-Efficient Momentum SGD for Decentralized Optimization | [Link](https://arxiv.org/abs/2005.07041) | Momentum-Enhanced SGD； Local Update Strategies； Distributed Hybrid Optimization | Accelerated Momentum； Local SGD； Local Momentum Updates； Compression & Local Updates | 
| DLCP | ![arXiv'20](https://img.shields.io/badge/arXiv'20-d9534f) | Domain-specific Communication Optimization for Distributed DNN Training | [Link](https://arxiv.org/abs/2008.08445) | Local Update Strategies | Local SGD |
| DEED-GD | ![arXiv'20](https://img.shields.io/badge/arXiv'20-d9534f) | DEED: A General Quantization Scheme for Communication Efficiency in Bits | [Link](https://arxiv.org/abs/2006.11401) | Gradient Compression & Quantization | Quantization Compression | 
...
| APMSqueeze | ![arXiv'20](https://img.shields.io/badge/arXiv'20-d9534f) | APMSqueeze: A Communication Efficient Adam-Preconditioned Momentum SGD Algorithm | [Link](https://arxiv.org/abs/2008.11343) | Gradient Compression & Quantization | Compression Error Compensation | 
...
| DP-PASGD | ![arXiv'20](https://img.shields.io/badge/arXiv'20-d9534f) | Differentially Private Federated Learning for Resource-Constrained Internet of Things | [Link](https://arxiv.org/abs/2003.12705) | Local Update Strategies | Adaptive Local Steps | 
...
| Interleaved-ShuffleG | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | The Cost of Shuffling in Private Gradient Based Optimization | [Link](https://arxiv.org/abs/2502.03652) | Decentralized Communication； Differential Privacy Optimization | Privacy-Preserving Decentralization； Privacy-Utility Balance |
| RaCO-DP | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Private Rate-Constrained Optimization with Applications to Fair Learning | [Link](https://arxiv.org/abs/2505.22703) | Differential Privacy Optimization | DP-SGD Variants | 
| DPZV | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | DPZV: Elevating the Tradeoff between Privacy and Utility in Zeroth-Order Vertical Federated Learning | [Link](https://arxiv.org/abs/2502.20565) | Gradient Noise Injection | Noise-Robust Optimization | 
...
| ANSGD | ![arXiv'23](https://img.shields.io/badge/arXiv'23-d9534f) | Learning across Data Owners with Joint Differential Privacy | [Link](https://arxiv.org/abs/2305.15723) | Differential Privacy Optimization | DP-SGD Variants | 
...
| GWT | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | Wavelet Meets Adam: Compressing Gradients for Memory-Efficient Training | [Link](https://arxiv.org/abs/2501.07237) | Low-Rank Gradient Storage | Gradient Low-Rank Projection | 
...
| LOMO | ![ACL'24](https://img.shields.io/badge/ACL'24-dfb317?labelColor=dfb317&color=dfb317&logoColor=1a202c) | Full Parameter Fine-tuning for Large Language Models with Limited Resources | [Link](https://arxiv.org/abs/2306.09782) | Towards LLM Traning； Memory-Efficient Fine-Tuning for Large Models | Real-Time Computation； Staless Fine-Tuning | 
| Sparse MeZO | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | Sparse MeZO: Less Parameters for Better Performance in Zeroth-Order LLM Fine-Tuning | [Link](https://arxiv.org/abs/2402.15751) | Perturbation Optimization； Memory-efficient Methods； Memory-Efficient Fine-Tuning for Large Models | Sparse Perturbation； Sparse Parameter Zeroth-Order； Selective Parameter Fine-Tuning | 
| A-GNB | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | HELENE: HESSIAN LAYER-WISE CLIPPING AND GRADIENT ANNEALING FOR ACCELERATING FINETUNING LLM WITH ZEROTH-ORDER OPTIMIZATION | [Link](https://arxiv.org/abs/2411.10696) | Low-Rank Gradient Storage | Dynamic Gradient Rank | 
...
| LeZO | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | SIMULTANEOUS COMPUTATION AND MEMORY EFFICIENT ZEROTH-ORDER OPTIMIZER FOR FINE-TUNING LARGE LANGUAGE MODELS | [Link](https://arxiv.org/abs/2410.09823) | Perturbation Optimization； Memory-efficient Methods； Memory-Efficient Fine-Tuning for Large Models | Sparse Perturbation； Sparse Parameter Zeroth-Order； Selective Parameter Fine-Tuning | 
| Adapprox | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | Adapprox: Adaptive Approximation in Adam Optimization via Randomized Low-Rank Matrices | [Link](https://arxiv.org/abs/2403.14958) | Low-Rank Methods | Projection\&Adjustment | 
| 4-bit shampoo | ![NeurIPS'24](https://img.shields.io/badge/NeurIPS'24-dfb317?labelColor=dfb317&color=dfb317&logoColor=1a202c) | 4-bit Shampoo for Memory-Efficient Network Training | [Link](https://arxiv.org/abs/2405.18144) | Preconditioned Gradient Methods； Low-Memory Optimizer Design | Two Metrics' Preconditioner； Compression&Approximation of States | 
| ADAACT | ![ICDMW'24](https://img.shields.io/badge/ICDMW'24-dfb317?labelColor=dfb317&color=dfb317&logoColor=1a202c) | AN ADAPTIVE METHOD STABILIZING ACTIVATIONS FOR ENHANCED GENERALIZATION | [Link](https://arxiv.org/abs/2506.08353) | Adaptive Learning Rate Methods； Optimizer State Compression | Neuron-Level Adaptation； State Sharing |
| sophia | ![ICLR'24](https://img.shields.io/badge/ICLR'24-dfb317?labelColor=dfb317&color=dfb317&logoColor=1a202c) | Sophia: A Scalable Stochastic Second-order Optimizer for Language Model Pre-training | [Link](https://arxiv.org/abs/2305.14342) | Hessian Approximation & Estimation； Curvature-Guided Preconditioning； Second-Order Moment Fusion； Privacy-Aware Gradient Clipping； Stateless Optimization Methods | Diagonal Hessian Approximation； Hessian Diagonal Preconditioning； Noise-Robust Second-Order Momentum； Real-Time Curvature Estimation |
...
| --- | --- | --- | --- | --- | --- | 
| AdaGC | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | AdaGC: Improving Training Stability for Large Language Model Pretraining | [Link](https://arxiv.org/abs/2502.11034) | Gradient Normalization & Clipping； Robust Optimization | Noise-Robust Normalization； Dynamic Gradient Clipping； Noise-Robust Gradients | 
| KO | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | KO: Kinetics-inspired Neural Optimizer with PDE Simulation Approaches | [Link](https://arxiv.org/abs/2505.14777) | Auto-Designed Optimizers | Automated Discovery&Theoretical Derivation | 
| BC-ADMM | ![arXiv'25](https://img.shields.io/badge/arXiv'25-d9534f) | BC-ADMM: An Efficient Non-convex Constrained Optimizer with Robotic Applications | [Link](https://arxiv.org/abs/2504.05465) | Robust Optimization | Structure-Aware Optimization | 
...
| WarpAdam | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | WarpAdam: A new Adam optimizer based on Meta-Learning approach | [Link](https://arxiv.org/abs/2409.04244) | Auto-Designed Optimizers | Evolutionary Strategies&Meta-Adaptive Learning | 
| AGS-GD | ![arXiv'24](https://img.shields.io/badge/arXiv'24-d9534f) | Anisotropic Gaussian Smoothing for Gradient-based Optimization | [Link](https://arxiv.org/abs/2411.11747) | Hybrid Methods； Auto-Designed Optimizers | Gradient Smoothing Hybrid； Automated Discovery&Theoretical Derivation | 
| Lion | ![NeurIPS'23](https://img.shields.io/badge/NeurIPS'23-dfb317?labelColor=dfb317&color=dfb317&logoColor=1a202c) | Symbolic Discovery of Optimization Algorithms | [Link](https://arxiv.org/abs/2302.06675) | Adaptive Learning Rate Methods； Auto-Designed Optimizers | Momentum-based Adaptive; Automated Discovery&Theoretical Derivation | 
| AdaNorm | ![WACV'23](https://img.shields.io/badge/WACV'23-dfb317?labelColor=dfb317&color=dfb317&logoColor=1a202c) | AdaNorm: Adaptive Gradient Norm Correction based Optimizer for CNNs | [Link](https://arxiv.org/abs/2210.06364) | Gradient Normalization & Clipping； Robust Optimization | Element-Wise Gradient Scaling； Noise-Robust Normalization； Noise-Robust Gradients | 
