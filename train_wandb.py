...
def main():
    ...
    if utils.is_primary(args):
     ...
     #log save added
        ...
        _logger.info(f'Log file saved to: {log_file}')
        ...
        if args.log_wandb:
            if has_wandb:
                ...
                wandb.init(
                    ...
                    group=safe_model_name(args.model), #add for compare optim in same group
                    name=exp_name,
                    config=args,
                ...
                wandb.define_metric("*", step_metric="epoch")  #relate step & epoch
            else:
                _logger.warning(
        ...
        for epoch in range(start_epoch, num_epochs):
            ...
            if loader_eval is not None:
                ...
                if args.log_wandb and has_wandb and utils.is_primary(args):
                    ...
                    wandb.log(log_dict, step=epoch)  #  x = epoch
            ...
            if output_dir is not None:
                ...
                utils.update_summary(
                    ...
                    log_wandb=False, #stop log auto to wandb
                )
